...
#+BEGIN_SRC python :results output verbatim
  ...
  fn = "data/Sigma-Ori/ING/4734/int20081118_00647195.fits.fz"
  hdulist = fits.open(fn)

  for ext in [1, 2, 3, 4]:
      hdu = fits.PrimaryHDU(header=hdulist[0].header, data=hdulist[ext].data)
      hdu.writeto(fn.replace(".fits.fz", f"-{ext}.fits"), overwrite=True)
