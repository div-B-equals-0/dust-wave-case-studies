...
+ But this is not quite right:
  ...
  + the region as a whole is larger
    ...
    + => 35 pc
  + We can add together Tr 14, Tr 15, and Tr 16
    + 
    + 
*** Carina kinematics
+ Low mass cluster stars have V = -12 (approx)
  + Damian:2016a
  + Range is -10 to -15
+ Gas seems to be expanding shells
  + Damian:2016a
  + Red component with V = +10
  + Blue component with V = -30
