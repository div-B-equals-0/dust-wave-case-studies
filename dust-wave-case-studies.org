...
#+BEGIN_SRC python :return figfile :results file
  ...
  # ... and the AV=1.5 model for the attenuated star
  mod2 = CloudyModel(os.path.join(CDC, "models", "shell-R003-n50-th1D-AV200"))
...
+ Everyone agrees V = 6.7
+ Absolute magnitude
  + with D = 410 pc, then DM = 5 log10(D) - 5 = 8.06
  + So M_V = 6.70 - 8.06 = -1.36
  + Simon-Diaz:2006a give M_V = -3.3 +/- 0.3 because they have used D = 450 pc => DM = 8.27 and they have compensated for A_V = 1.79
    ...
    + I would get -3.15 using D = 410, but correcting for extinction
