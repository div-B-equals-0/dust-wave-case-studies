...
+ Conversion to mass-loss rate
  + Mdot_-7 = 2.02 \eta_w L_4 / V_3
    + \eta_w = \eta_sh - 1.25 \tau
  + Mdot_-7 = \tau [495 R_{pc} T_{4} / \kappa_{600} h_{1/4} V_{3 }- 1.25]
    + At least this removes one power of the L_\star
    + Mdot_-7 = 2 (F_IR D^2 / L_4) [2.4 \theta_as D_kpc T_{4} / \kappa_{600} h_{1/4} V_{3 }- 1.25]
