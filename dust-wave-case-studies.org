...
+ Steps to do
  + [X] Check against original ACS images
  ...
  + [ ] Compare photometry with results from Robberto:2013a
    ...
    + Repeat for all the filters: 
      ...
      + Stil 4 to 5 times too small - why?

  + [ ] Is it anything to do with the non-standard gain?
***** DONE Optical lines
CLOSED: [2018-10-31 Wed 22:39]
  + Lines we have
    + ACS F658N
