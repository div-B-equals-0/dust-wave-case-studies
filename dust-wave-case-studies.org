...
#+header: :var intab=ney-allen-sed magtab=th1d-magnitudes :colnames no
#+BEGIN_SRC python :return figfile :results file
  import numpy as np
  from astropy.table import Table
  from matplotlib import pyplot as plt
  ...
  # Plot stellar SED from magnitude data
  ax.errorbar('Wave', 'star', xerr='dWave', yerr='E(star)',
              data=magdata, label='star',
              ls='none', marker='.', color='0.5', alpha=1.0,
  )
  ...
  # Plot Cloudy models ...
  LSUN = 3.82e33
  # ... the AV=0.03 model for the dust shell ...
  mod = CloudyModel(os.path.join(CDC, "models", "shell-R003-n50-th1D-triple-AV3"))
  # ... and the AV=1.5 model for the attenuated star
  mod2 = CloudyModel(os.path.join(CDC, "models", "shell-R003-n50-th1D-AV150"))
...
|                   |        |   \mu{}m |    \mu{}m |    Jy |       |       | Jy            |
|-------------------+--------+------+-------+-------+-------+-------+---------------|
| Morell:1978a      | U      | 0.36 |  0.15 |  1810 |  5.96 |  0.05 | 7.48 +/- 0.34 |
| Morell:1978a      | B      | 0.44 |  0.22 |  4260 |  6.78 |  0.05 | 8.27 +/- 0.38 |
| Morell:1978a      | V      | 0.55 |  0.16 |  3640 |  6.70 |  0.05 | 7.61 +/- 0.35 |
| Morell:1978a      | R      | 0.64 |  0.23 |  3080 |  6.40 |  0.02 | 8.48 +/- 0.16 |
| Morell:1978a      | I      | 0.79 |  0.19 |  2550 |  6.21 |  0.02 | 8.37 +/- 0.15 |
| Mermilliod:1987a  | U      | 0.36 |  0.15 |  1810 |  5.97 |  0.10 | 7.41 +/- 0.68 |
| Hoffleit:1991a    | B      | 0.44 |  0.22 |  4260 |  6.79 |  0.05 | 8.19 +/- 0.38 |
| GAIA DR2          | G      | 0.52 |  0.14 |  3730 |  6.56 |  0.02 | 8.87 +/- 0.16 |
| Hillenbrand:1997a | V      | 0.55 |  0.16 |  3640 |  6.70 |  0.05 | 7.61 +/- 0.35 |
| Hillenbrand:1997a | I      | 0.79 |  0.19 |  2550 |  6.30 |  0.05 | 7.70 +/- 0.35 |
| Robberto:2010a    | J      | 1.26 |  0.16 |  1600 | 7.146 |  0.02 | 2.22 +/- 0.04 |
| Robberto:2010a    | H      | 1.60 |  0.23 |  1080 | 5.891 | 0.053 | 4.75 +/- 0.23 |
| Robberto:2010a    | K      | 2.22 |  0.23 |   670 | 5.751 | 0.027 | 3.35 +/- 0.08 |
| Hillenbrand:1998a | J      | 1.26 |  0.16 |  1600 |  6.01 |  0.05 | 6.31 +/- 0.29 |
| Hillenbrand:1998a | H      | 1.60 |  0.23 |  1080 |  5.84 |  0.05 | 4.98 +/- 0.23 |
| Hillenbrand:1998a | K      | 2.22 |  0.23 |   670 |  5.69 |  0.05 | 3.55 +/- 0.16 |
| Hillenbrand:1998a | L      | 3.45 |   0.3 |   290 |  5.70 |  0.05 | 1.52 +/- 0.07 |
...
| Band   |    wav |  dwav |     F |    dF |
|--------+--------+-------+-------+-------|
|        | 0.1150 | 0.006 | 4.191 | 0.441 |
|        | 0.1200 | 0.003 | 1.921 | 0.961 |
|        | 0.1220 | 0.003 | 0.248 | 0.149 |
|        | 0.1250 | 0.003 | 3.127 | 1.042 |
|        | 0.1300 |  0.02 | 4.792 | 0.564 |
|        | 0.1400 |  0.02 | 4.576 | 0.654 |
|        | 0.1600 |  0.02 | 4.013 | 0.427 |
|        | 0.1800 |  0.02 | 3.999 | 0.540 |
|        | 0.2000 |  0.02 | 3.602 | 0.400 |
|        | 0.2100 |  0.02 | 2.648 | 0.294 |
|        | 0.2257 |  0.02 | 2.294 | 0.170 |
|        | 0.2500 |  0.02 | 3.127 | 0.208 |
|        | 0.2750 |  0.02 | 3.405 | 0.252 |
|        | 0.3000 |  0.02 | 3.152 | 0.300 |
| U      |   0.36 |  0.15 |  7.48 |  0.34 |
| B      |   0.44 |  0.22 |  8.27 |  0.38 |
| V      |   0.55 |  0.16 |  7.61 |  0.35 |
| R      |   0.64 |  0.23 |  8.48 |  0.16 |
| I      |   0.79 |  0.19 |  8.37 |  0.15 |
| U      |   0.36 |  0.15 |  7.41 |  0.68 |
| B      |   0.44 |  0.22 |  8.19 |  0.38 |
| G      |   0.52 |  0.14 |  8.87 |  0.16 |
| V      |   0.55 |  0.16 |  7.61 |  0.35 |
| I      |   0.79 |  0.19 |  7.70 |  0.35 |
| J      |   1.26 |  0.16 |  2.22 |  0.04 |
| H      |   1.60 |  0.23 |  4.75 |  0.23 |
| K      |   2.22 |  0.23 |  3.35 |  0.08 |
| J      |   1.26 |  0.16 |  6.31 |  0.29 |
| H      |   1.60 |  0.23 |  4.98 |  0.23 |
| K      |   2.22 |  0.23 |  3.55 |  0.16 |
| L      |   3.45 |   0.3 |  1.52 |  0.07 |
...
+ At the momemt, we have two problems
  ...
  2. UV SED is lower than U-band magnitude suggests
