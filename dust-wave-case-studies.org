...
+ Candidate driving source of CO shell 12 from Feddersen:2018a
  + Strangely, LP Ori is candidate for driving shell 11, which I don't beleive
...
+ We will also do the flux in a proper aperture
  ...
  + Use sector 4 as BG:
    ...
    + Taking a box instead I get 0.41 +/- 0.12 Jy/arcsec^2 for BG = 17.4 +/- 5.1 GJy/sr
      + Let's go with that
...
#+name: ney-allen-sed
| Instrument      |  Wave | dWave |     S | E(S) |
|-----------------+-------+-------+-------+------|
| Spitzer IRAC    |   3.6 |   0.8 |  1.45 |  0.2 |
| Spitzer IRAC    |   4.5 |   1.0 |   2.4 |  0.2 |
| Spitzer IRAC    |   5.8 |   1.6 | 4.426 |  0.6 |
| WIRO Short      |  7.58 |   0.8 |   11. |   4. |
| SOFIA FORCAST   |   7.7 |  0.47 |   7.2 |  2.9 |
| Spitzer IRAC    |   8.0 |   2.9 |  16.6 |    2 |
| WIRO Short      |  8.21 |  1.54 |   20. |   4. |
| WIRO Short      |  9.48 |  1.66 |   74. |   4. |
| UKIRT MAX       |  10.1 |  3.13 | 131.5 | 20.8 |
| WIRO Short      | 10.48 |  1.42 |   98. |   6. |
| WIRO Short      | 11.40 |  1.41 |   86. |   4. |
| Hale SpectroCam |  11.7 |   1.0 |       |      |
| Gemini T-RecS   |  11.7 |  1.11 | 161.1 | 10.7 |
| WIRO Short      | 12.43 |  1.34 |   72. |   6. |
| WIRO Long       | 15.69 |  2.22 |  298. | 128. |
| WIRO Long       | 17.37 |  2.94 |  319. |  21. |
| WIRO Long       | 19.62 |  2.88 |  436. |  43. |
| UKIRT MAX       |  19.7 |  2.44 | 166.1 | 27.7 |
| SOFIA FORCAST   |  19.7 |   5.5 | 306.4 | 54.1 |
| WIRO Long       | 21.42 |  2.76 |  383. |  43. |
| WIRO Long       | 22.82 |  3.06 |  404. | 213. |
| WIRO Long       | 24.30 |  2.52 |  676. | 425. |
| SOFIA FORCAST   |  37.1 |   3.3 | 165.8 | 21.6 |
| Herschel PACS   |    70 |    25 |  10.8 |  1.7 |
| Herschel PACS   |   160 |    80 |   0.1 |  4.2 |
...
#+BEGIN_SRC python :return figfile :results file 
  ...
  data['sed'] = 0.665 * 2.9979e-9 * 5.265e9 *data['S'] / data['Wave']
  ...
  ax.legend(loc='lower center', title='Instrument')
  ax.set(
